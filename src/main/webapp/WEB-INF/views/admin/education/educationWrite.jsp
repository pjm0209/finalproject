		...
		<div class="educationWrite-body">
			<div class="educationWrite-setting">
				...
				<div class="educationWrite-setting-body" >
					<dt>교육 이름</dt>
					<dd>
						<div class="input_group v2"><input class="form-control" type="text" name="eduName" id="education_name" maxlength="60"></div>
					</dd>
					<dt>강사명</dt>
					<dd>
						<div class="mb-3">
					...
					<dt>교육 기간</dt>
					<dd>
						<div><input type="date" name="eduCom" class="form-control"></div>
					</dd>
					<dt>최대 인원</dt>
					<dd>
						<div class="input_group v2"><input class="form-control" type="text" name="eduPeopleNumber" id="education_people" maxlength="10"></div>
					</dd>
					<dt>교육비</dt>
					<dd>
						<div class="input_group v2"><input class="form-control" type="text" name="eduPrice" id="education_price" maxlength="10"></div>
					</dd>
					<dt>교육장</dt>
					<dd>
						<div class="mb-3">
